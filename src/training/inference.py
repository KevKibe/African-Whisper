...
def initialize_pipeline(model_name, language_abbr, tokenizer, huggingface_read_token):
    ...
    pipe.model.config.forced_decoder_ids = pipe.tokenizer.get_decoder_prompt_ids(language=language_abbr, task="transcribe")

    return pipe

def transcribe(microphone, file_upload, pipe):
    warn_output = ""
...
def generate_demo(model_name, language_abbr, tokenizer, huggingface_read_token):
    pipe = initialize_pipeline(model_name, language_abbr, tokenizer, huggingface_read_token)
...
if __name__ == "__main__":
    args = parse_args()
    generate_demo(args.model_name, args.language_abbr, args.tokenizer, args.huggingface_read_token)
